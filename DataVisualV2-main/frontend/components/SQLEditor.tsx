...
import { Play, Sparkles, Database, Copy, ChevronDown } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-slate-900 text-slate-200 relative">
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="flex-1 min-w-0 flex flex-col border-r border-slate-800">
          ...
          {/* Results Pane */}
          <div className="flex-1 min-w-0 min-h-[300px] border-t border-slate-800 bg-slate-900 flex flex-col overflow-hidden">
